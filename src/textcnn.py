...
if __name__ == '__main__':
    ...
    x_train, x_test, y_train, y_test = train_test_split(df['content'], df['label'], test_size=0.1)
    ...
    print(x_train_padded_seqs.size,y_train.size,x_test_padded_seqs.size,y_test.size)
