...
def TextCNN_model_1(x_train_padded_seqs, y_train, x_test_padded_seqs, y_test):
    ...
    model.fit(x_train_padded_seqs, one_hot_labels, batch_size=100, epochs=50)
...
if __name__ == '__main__':
    ...
    x_train_padded_seqs = pad_sequences(x_train_word_ids, maxlen=100)  # 将超过固定值的部分截掉，不足的在最前面用0填充
    ...
    test_word_squences = pad_sequences(test_word_ids, maxlen=100)
